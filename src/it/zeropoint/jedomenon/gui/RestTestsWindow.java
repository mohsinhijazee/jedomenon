...
import it.zeropoint.jedomenon.rest.Instance;
 ...
 */
public class RestTestsWindow extends javax.swing.JFrame {
  
  /** Creates new form RestTestsWindow */
  public RestTestsWindow() {
    initComponents();
  }
  ...
  private void initComponents() {
    ...
    getInstances.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(java.awt.event.ActionEvent evt) {
        getInstancesActionPerformed(evt);
      }
    });
  ...
  private void getInstancesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getInstancesActionPerformed

    try
    {
      Entity e = new Entity(101);
      Instance[] instances = e.getInstances();
      
      String msg = "";
      String json = toJSON(instances, 2);
      msg = "JSON: \n" + json;
      JOptionPane.showMessageDialog(this, msg);
      String[] names = instances[0].getDetailNames();
      
      JOptionPane.showMessageDialog(this, instances[0].getValueOf(names[0]));
      JOptionPane.showMessageDialog(this, instances[0].getValueOf(names[1]));
  ...
  }//GEN-LAST:event_getInstancesActionPerformed
